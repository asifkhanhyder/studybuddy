...
**Model used:** `gemini-2.0-flash` via the Google Gemini API (free tier, no card required), called directly from the browser.
...
- **AI model:** Google Gemini (`gemini-2.0-flash`) via the Gemini API free tier, called client-side
